##https://github.com/sahudsonleck/terraform-aws-controlshift-redshift-sync/blob/main/glue_job.tf
...
#############
locals {
  signatures_s3_path = "s3://service-glue-repo-${var.environment}/${var.organization}/signatures"
}
